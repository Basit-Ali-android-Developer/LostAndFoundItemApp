...
public class StudentHistoryItemDetails extends AppCompatActivity {
    ImageButton backbutton;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_student_history_item_details);
...
//        // Initialize views
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(StudentHistoryItemDetails.this,HomeFinal.class);
