...
public class StudentAuctionHistoryFragment extends Fragment {
    ...
    public StudentAuctionHistoryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_student_auction_history, container, false);
        ...
        AuctionHistoryAdapter = new AuctionHistoryAdapter(getContext(), ItemsList,StudentAuctionHistoryDetailsActivity.class);
    ...
    private void fetchAuctionHistoryItems() {
        ...
        String URL = "http://10.0.2.2/Projectfinal/api/AuctionHistory/GetHistoryByRegNo?regNo="+regNo;
