...
public class AdminAuctionHistoryDetailsActivity extends AppCompatActivity {
    ImageButton backbutton;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_admin_auction_history_details);
       ...
       int soldPrice = getIntent().getIntExtra("soldPrice", 0);
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AdminAuctionHistoryDetailsActivity.this, AdminHomeFinal.class);
                intent.putExtra("FragmentToLoad", "AdminAuctionHistoryFragment");  // You can change the fragment name here
